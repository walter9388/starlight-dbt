...
export const dbtManifestSchema = z.object({
		...
		.record(
			z.union([
				z.object({
					...
					alias: z.string(),
					checksum: z.object({ name: z.string(), checksum: z.string() }),
					config: z
						.object({
					...
					depends_on: z.object({ macros: z.array(z.string()).optional() }).optional(),
					defer_relation: z
						.union([
							z.object({
								database: z.union([z.string(), z.null()]),
				...
				z.object({
					...
					extra_ctes: z.array(z.object({ id: z.string(), sql: z.string() })).optional(),
							...
							warn_after: z
								.union([
									z.object({
										...
										period: z.union([z.enum(['minute', 'hour', 'day']), z.null()]).default(null),
									}),
									z.null(),
								])
								.optional(),
		...
		.record(
			z.object({
				...
				arguments: z
					...
					.optional(),
				created_at: z.number().optional(),
				supported_languages: z.union([z.array(z.enum(['python', 'sql'])), z.null()]).default(null),
			})
		)
	...
	exposures: z
		.record(
			z.object({
				...
				depends_on: z
					.object({ macros: z.array(z.string()).optional(), nodes: z.array(z.string()).optional() })
					.optional(),
				refs: z
					.array(
						z.object({
	...
	metrics: z
		.record(
			z.object({
						...
						.union([
							z.object({
								...
								filter: z
									.union([
										z.object({
											where_filters: z.array(z.object({ where_sql_template: z.string() })),
										}),
										z.null(),
									])
									.default(null),
					...
					numerator: z
						.union([
							z.object({
								...
								alias: z.union([z.string(), z.null()]).default(null),
								offset_window: z
									.union([z.object({ count: z.number().int(), granularity: z.string() }), z.null()])
									.default(null),
						...
						.union([
							z.array(
								z.object({
									...
									offset_window: z
										.union([
											z.object({ count: z.number().int(), granularity: z.string() }),
											z.null(),
										])
										.default(null),
									offset_to_grain: z.union([z.string(), z.null()]).default(null),
					...
					conversion_type_params: z
						.union([
							z.object({
								...
								entity: z.string(),
								calculation: z.enum(['conversions', 'conversion_rate']).default('conversion_rate'),
								window: z
									.union([z.object({ count: z.number().int(), granularity: z.string() }), z.null()])
									.default(null),
								constant_properties: z
									.union([
										z.array(
											z.object({ base_property: z.string(), conversion_property: z.string() })
										),
										z.null(),
									])
									.default(null),
				...
				filter: z
					.union([
						z.object({ where_filters: z.array(z.object({ where_sql_template: z.string() })) }),
						z.null(),
					])
					.default(null),
				metadata: z
				...
				z.array(
					z.union([
						...
						z.object({
							...
							config: z
								.object({
									...
									schema: z.union([z.string(), z.null()]).default(null),
									cache: z.object({ enabled: z.boolean().default(false) }).optional(),
								})
								.catchall(z.any())
								.optional(),
							unrendered_config: z.record(z.any()).optional(),
						...
						z.object({
							...
							defaults: z
								.union([
									z.object({ agg_time_dimension: z.union([z.string(), z.null()]).default(null) }),
									z.null(),
								])
								.default(null),
							entities: z
								.array(
									z.object({
										...
										expr: z.union([z.string(), z.null()]).default(null),
										config: z
											.union([z.object({ meta: z.record(z.any()).optional() }), z.null()])
											.default(null),
									})
								)
								.optional(),
