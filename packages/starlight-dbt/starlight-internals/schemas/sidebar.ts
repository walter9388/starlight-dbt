...
export const SidebarGroupSchema = SidebarBaseSchema.extend({
	/**
...
export const SidebarLinkItemSchema = SidebarBaseSchema.extend({
...
export const AutoSidebarGroupSchema = SidebarGroupSchema.extend({
...
export const InternalSidebarLinkItemSchema = SidebarBaseSchema.partial({ label: true }).extend({
